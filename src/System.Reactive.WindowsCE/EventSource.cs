...
namespace System.Reactive
{
    internal sealed class EventSource<T> : IEventSource<T>
    {
        ...
        private readonly Action<Action2<T>, /*object,*/ T> _invokeHandler;

        public EventSource(IObservable<T> source, Action<Action2<T>, /*object,*/ T> invokeHandler)
        {
            _source = source;
