...
namespace System.Reactive.Linq
{
    ...
    internal interface IQueryLanguage
    {
        ...
        IObservable<EventPattern<TEventArgs>> FromEventPattern<TDelegate, TEventArgs>(Func<EventHandler2<TEventArgs>, TDelegate> conversion, Action<TDelegate> addHandler, Action<TDelegate> removeHandler);
        IObservable<EventPattern<TEventArgs>> FromEventPattern<TDelegate, TEventArgs>(Func<EventHandler2<TEventArgs>, TDelegate> conversion, Action<TDelegate> addHandler, Action<TDelegate> removeHandler, IScheduler scheduler);
        IObservable<EventPattern<TEventArgs>> FromEventPattern<TEventArgs>(Action<EventHandler2<TEventArgs>> addHandler, Action<EventHandler2<TEventArgs>> removeHandler);
        IObservable<EventPattern<TEventArgs>> FromEventPattern<TEventArgs>(Action<EventHandler2<TEventArgs>> addHandler, Action<EventHandler2<TEventArgs>> removeHandler, IScheduler scheduler);
