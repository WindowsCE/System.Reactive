...
namespace System.Reactive.Linq
{
    ...
    internal partial class QueryLanguage
    {
        ...
        public virtual IObservable<EventPattern<TEventArgs>> FromEventPattern<TDelegate, TEventArgs>(Func<EventHandler2<TEventArgs>, TDelegate> conversion, Action<TDelegate> addHandler, Action<TDelegate> removeHandler)
        {
            return FromEventPattern_<TDelegate, TEventArgs>(conversion, addHandler, removeHandler, GetSchedulerForCurrentContext());
        }

        public virtual IObservable<EventPattern<TEventArgs>> FromEventPattern<TDelegate, TEventArgs>(Func<EventHandler2<TEventArgs>, TDelegate> conversion, Action<TDelegate> addHandler, Action<TDelegate> removeHandler, IScheduler scheduler)
        {
        ...
        private static IObservable<EventPattern<TEventArgs>> FromEventPattern_<TDelegate, TEventArgs>(Func<EventHandler2<TEventArgs>, TDelegate> conversion, Action<TDelegate> addHandler, Action<TDelegate> removeHandler, IScheduler scheduler)
        {
        ...
        {
            return new FromEventPattern.Impl<TDelegate, TEventArgs>(eh => conversion((s, e) => eh(s, e)), addHandler, removeHandler, scheduler);
        }
        ...
        public virtual IObservable<EventPattern<TEventArgs>> FromEventPattern<TEventArgs>(Action<EventHandler2<TEventArgs>> addHandler, Action<EventHandler2<TEventArgs>> removeHandler)
        {
            return FromEventPattern_<TEventArgs>(addHandler, removeHandler, GetSchedulerForCurrentContext());
        }

        public virtual IObservable<EventPattern<TEventArgs>> FromEventPattern<TEventArgs>(Action<EventHandler2<TEventArgs>> addHandler, Action<EventHandler2<TEventArgs>> removeHandler, IScheduler scheduler)
        {
        ...
        private static IObservable<EventPattern<TEventArgs>> FromEventPattern_<TEventArgs>(Action<EventHandler2<TEventArgs>> addHandler, Action<EventHandler2<TEventArgs>> removeHandler, IScheduler scheduler)
        {
            return new FromEventPattern.Impl<EventHandler2<TEventArgs>, TEventArgs>(handler => handler, addHandler, removeHandler, scheduler);
        }
        ...
        {
            return new FromEventPattern.Impl<EventHandler<TEventArgs>, TEventArgs>(handler => (s, e) => handler(s, e), addHandler, removeHandler, scheduler);
        }
