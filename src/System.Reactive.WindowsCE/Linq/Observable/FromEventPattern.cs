...
namespace System.Reactive.Linq.ObservableImpl
{
    internal sealed class FromEventPattern
    {
        ...
        {
            private readonly Func<EventHandler2<TEventArgs>, TDelegate> _conversion;
            ...
            public Impl(Func<EventHandler2<TEventArgs>, TDelegate> conversion, Action<TDelegate> addHandler, Action<TDelegate> removeHandler, IScheduler scheduler)
                : base(addHandler, removeHandler, scheduler)
            {
